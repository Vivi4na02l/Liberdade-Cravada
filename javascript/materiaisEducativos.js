let content = [
    ...
    },
    {
        ...
        allText: [ /** posPage */
            { page: 1,
                active: true,
                text: 'Os militares, reunidos no chamado <span class="red underlined">Movimento das Forças Armadas (MFA)</span>, organizaram-se de forma clandestina. Em março, ocorreu uma tentativa falhada de golpe militar. Cerca de 200 militares foram presos. Apesar do fracasso, o movimento não parou. A 24 de março, os líderes do MFA decidiram avançar com um golpe definitivo. <br><br> Na noite de 24 para 25 de abril, tudo foi posto em marcha. A música "E Depois do Adeus", de Paulo de Carvalho, foi o primeiro sinal, seguido da canção "Grândola Vila Morena", de Zeca Afonso, transmitida na Rádio Renascença, que confirmava que o <span class="red underlined">golpe estava em andamento</span>. As tropas começaram então a ocupar os principais pontos estratégicos de Lisboa: o aeroporto, rádios, ministérios, e quartéis.' },
            { page: 2,
                active: false,
                text: "Milhares de pessoas saíram à rua para apoiar os militares. Os populares ofereceram <span class='red underlined'>cravos aos soldados, que os colocaram nos canos das espingardas</span>, conhecido até hoje como um gesto simbólico que deu nome à <span class='red underlined'>Revolução dos Cravos</span>. <br><br> Ao longo do dia 25 de abril, Marcelo Caetano refugiou-se no Quartel do Carmo, mas, após algumas horas, rendeu-se e o <span class='red underlined'>regime caiu sem grande derramamento de sangue</span>. Similarmente, desde as primeiras horas da revolução, os militares cercavam a sede da DGS, até pouco tempo denominada de PIDE. No entanto, houve repressão final: agentes da polícia política dispararam contra manifestantes, matando quatro pessoas." },
            { page: 3,
                active: false,
